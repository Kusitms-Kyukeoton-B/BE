package com.kyukeoton_b.kyukeotonB_be.domain.s3.service;
...
import com.kyukeoton_b.kyukeotonB_be.domain.s3.exception.S3Exception;
...
public class AwsS3Service {
    ...
    public String uploadFile(MultipartFile file) {
        try {
            ...
            throw new S3Exception(S3_NOT_FOUND);
        }
    }
